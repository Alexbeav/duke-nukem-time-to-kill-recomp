...
[![GitHub downloads (all assets, all releases)](https://img.shields.io/github/downloads/TechnicallyComputers/Duke-Nukem-Time-to-Kill/total)](https://github.com/TechnicallyComputers/Duke-Nukem-Time-to-Kill/releases)
[![GitHub downloads (latest release)](https://img.shields.io/github/downloads/TechnicallyComputers/Duke-Nukem-Time-to-Kill/latest/total)](https://github.com/TechnicallyComputers/Duke-Nukem-Time-to-Kill/releases/latest)
[![GitHub release](https://img.shields.io/github/v/release/TechnicallyComputers/Duke-Nukem-Time-to-Kill)](https://github.com/TechnicallyComputers/Duke-Nukem-Time-to-Kill/releases/latest)
<!-- /retcomm-readme-metrics -->
...
Zip prefix for CI artifacts: `dntk`.

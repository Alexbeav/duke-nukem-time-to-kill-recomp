# Duke Nukem: Time to Kill Recompiled
<!-- retcomm-readme-metrics -->
[![GitHub downloads (all assets, all releases)](https://img.shields.io/github/downloads/Alexbeav/duke-nukem-time-to-kill-recomp/total)](https://github.com/Alexbeav/duke-nukem-time-to-kill-recomp/releases)
[![GitHub downloads (latest release)](https://img.shields.io/github/downloads/Alexbeav/duke-nukem-time-to-kill-recomp/latest/total)](https://github.com/Alexbeav/duke-nukem-time-to-kill-recomp/releases/latest)
[![GitHub release](https://img.shields.io/github/v/release/Alexbeav/duke-nukem-time-to-kill-recomp)](https://github.com/Alexbeav/duke-nukem-time-to-kill-recomp/releases/latest)
<!-- /retcomm-readme-metrics -->

Static recompilation of **Duke Nukem: Time to Kill** built on
...
Zip prefix for CI artifacts: `Duke-Nukem-Time-to-Kill-Recomp`.
...
The `v0.3.3` source uses `Duke_Nukem__Time_to_Kill_Recompiled` in CMake, the setup relaunch, and the packager.

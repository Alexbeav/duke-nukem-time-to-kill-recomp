...
The supported serial set is $(@{ordinal=1; slug=duke-nukem-time-to-kill; title=Duke Nukem: Time to Kill; serials=System.Object[]; expected_disc_count=1; identity_complete=True; risks=System.Object[]}.serials -join ', '). The package uses

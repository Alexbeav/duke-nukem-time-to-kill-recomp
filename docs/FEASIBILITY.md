...
The supported serial set is `SLUS-00583`. The package uses
...
The corrected source uses `Duke_Nukem__Time_to_Kill_Recompiled` for CMake, the setup relaunch, and packaging.

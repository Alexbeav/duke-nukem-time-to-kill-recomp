...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    ...
    .project_root_env = "DUKE_NUKEM_TIME_TO_KILL_RECOMP_PROJECT_ROOT",
    .build_dir_env = "DUKE_NUKEM_TIME_TO_KILL_RECOMP_BUILD_DIR",
    .force_setup_env = "DUKE_NUKEM_TIME_TO_KILL_RECOMP_FORCE_SETUP",

...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    .display_name = "Duke Nukem Time to Kill",
    .project_root_env = "DUKE_NUKEM_TIME_TO_KILL_PROJECT_ROOT",
    .build_dir_env = "DUKE_NUKEM_TIME_TO_KILL_BUILD_DIR",
    .force_setup_env = "DUKE_NUKEM_TIME_TO_KILL_FORCE_SETUP",
    ...
    .exe_basename = "Duke_Nukem_Time_to_Kill",
    .prepare_note =
